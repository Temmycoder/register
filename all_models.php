            ...
            if(mysqli_num_rows($result) > 0){
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    echo "<tbody>
                        <tr>
                            <td>".$i."</td>
                            <td><a href='model_file.php?id=$row[id]'><img class='img-fluid' width='44' src=".$row['pic']." /><a></td>
                            <td>".$row['full_name']."</td>
                            <td>".$row['email']."</td>
                            <td>".$row['username']."</td>
                            <td>".$row['votes']."</td>
                            <td>".$row['created_by']."</td>
                            <td>".$state." <input type=hidden value='$row[status]'>
                              
                            </td>
                            <form method='post'>
                            <td><a href='#dismissModal?status=$row[status]' role='button' data-bs-toggle='modal' data-bs-target='#dismissModal'
                                data-id='" . $row['id'] . "' data-status='" . $cur_status . "'>
                                <i class='fa ".$toggle." text-primary'></i></a></td>
                                <div class='modal fade' id='dismissModal' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                                    <div class='modal-dialog' role='document'>
                                        <div class='modal-content'>
                                          ...
                                          Are you sure you want to change the status of <b>".$row['full_name']."<b>
                                            </div>
